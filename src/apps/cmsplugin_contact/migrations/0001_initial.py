...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_contact', (
            ...
            ('name_label', self.gf('django.db.models.fields.CharField')(default=u'Your Full Name', max_length=100)),
            ('email_label', self.gf('django.db.models.fields.CharField')(default=u'Your Email', max_length=100)),
    ...
    models = {
        ...
        'cmsplugin_contact.contact': {
            ...
            'email_label': ('django.db.models.fields.CharField', [], {'default': "u'Your Email'", 'max_length': '100'}),
            'name_label': ('django.db.models.fields.CharField', [], {'default': "u'Your Full Name'", 'max_length': '100'}),
